...
mixin _$TodoModel {
 ...
 String get id; String get title; String? get description;@JsonKey(name: "is_favorite") bool get isFavorite;@JsonKey(name: "is_done") bool get isDone;@JsonKey(name: "created_at") String get createdAt;
...
@useResult
$Res call({
 String id, String title, String? description,@JsonKey(name: "is_favorite") bool isFavorite,@JsonKey(name: "is_done") bool isDone,@JsonKey(name: "created_at") String createdAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String? description, @JsonKey(name: "is_favorite")  bool isFavorite, @JsonKey(name: "is_done")  bool isDone, @JsonKey(name: "created_at")  String createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TodoModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String? description, @JsonKey(name: "is_favorite")  bool isFavorite, @JsonKey(name: "is_done")  bool isDone, @JsonKey(name: "created_at")  String createdAt)  $default,) {final _that = this;
switch (_that) {
case _TodoModel():
return $default(_that.id,_that.title,_that.description,_that.isFavorite,_that.isDone,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  String? description, @JsonKey(name: "is_favorite")  bool isFavorite, @JsonKey(name: "is_done")  bool isDone, @JsonKey(name: "created_at")  String createdAt)?  $default,) {final _that = this;
switch (_that) {
case _TodoModel() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.isFavorite,_that.isDone,_that.createdAt);case _:
  return null;
...
class _TodoModel implements TodoModel {
  const _TodoModel({required this.id, required this.title, required this.description, @JsonKey(name: "is_favorite") required this.isFavorite, @JsonKey(name: "is_done") required this.isDone, @JsonKey(name: "created_at") required this.createdAt});
